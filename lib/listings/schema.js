...
ListingMain = new SimpleSchema({
	...
	type: Number,
	decimal: true,
	min: 0,//Main.findOne().payments.minPrice,
	...
	decimal: true,
	min: 0,
	label: function () {return TAPi18n.__('Shipping fee on top of each order (0 - no shipping)')},
	optional: true,
	custom: function () {
	    var res=getField(this.key,this.field("listingType").value);
	    return customVal (res,this);
    ...
    datePick: {
	type: String,
	label: function () {return TAPi18n.__('Pick needed dates:')},
	autoform: {
	    afFieldInput: {
	...
	optional:true,
	custom: function () {
	    //if item name day - in in listingEdit
	    if ((this.field('itemName').value==='day') && (typeof this.value==='undefined') && (Router.current().lookupTemplate()!="SpecificListingEdit")) {
		return "required";
	    };
	}
    },
    ...
    payeeEmail: {
        ...
        label: function () {return TAPi18n.__("Payee e-mail")}
    }
});
