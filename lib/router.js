...
Router.onAfterAction(function () {
    ...
    //check if there are previous favicon
    while (document.getElementById('theme-favicon')) {
	document.head.removeChild(document.getElementById('theme-favicon'))
    };
    ...
    fav.setAttribute("id", "theme-favicon");
    fav.setAttribute("type", "text/css");
    fav.setAttribute("href", res);
