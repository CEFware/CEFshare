...
Template.afFileUpload_custom.destroyed = function() {
    var name;
    name = this.data.name;
    return Session.set('fileUpload[' + name + ']', null);
};

Template.afFileUpload_custom.events({
...
Template.afFileUpload_custom.onRendered(function(){

});
Template.afFileUpload_custom.helpers({
